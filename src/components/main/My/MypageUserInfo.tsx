    ...
    >
      <div
        className={`w-[647px] bg-primary-400/25 rounded-[25px] 
            border-2 border-white z-10 shadow-default mt-[100px] h-[900px]`}
      >
        {/*창 안의 요소*/}
        <div className="flex flex-col items-center mt-[43px] h-full">
            {/* 프로필 수정 상단네비 */}
            <div className="flex flex-row items-center justify-between w-[572px] mb-[136px]">
              <nav>
                <Link to="/my-page" >
              ...
              <button className="font-pretendard font-semiBold text-primary-700 text-base mr-1">Done</button>
            </div>
            ...
            <div className="flex flex-col items-center">
              <div
                ...
                className="w-[96px] h-[96px] bg-[#f3d0d9] rounded-full"/>
                <img
                  className="absolute top-[380px] left-[400px]" 
                  src={profileImg_N} 
                  alt="프로필 수정 아이콘" />
