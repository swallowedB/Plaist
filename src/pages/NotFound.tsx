      ...
      >
        <div className="flex flex-col items-center mt-[95px]">
          <div className="flex flex-col items-center">
            ...
            >
              <p className="font-rubik text-[40px] rotate-90 text-white ">
                {" "}
                ({" "}
              </p>
              <p className="font-rubik text-[40px] rotate-90 text-white ">
            ...
            <h1
              style={{ textShadow: "0px 4px 15px rgba(47, 125, 215, 0.50)" }}
              className="font-rubik text-[100px] text-white leading-[119px] "
            >
              404
            </h1>
          </div>
          <h2
            style={{ textShadow: "0px 4px 15px rgba(47, 125, 215, 0.50)" }}
            className="font-rubik text-[50px] text-white mt-8"
          >
            Oops!
          </h2>
          <p
            style={{ textShadow: "0px 4px 15px rgba(47, 125, 215, 0.50)" }}
            className="text-center font-pretendard font-semiBold text-white text-[20px] mt-[50px]"
          >
            잘못 찾아오셨어요. <br /> 나가시는 길은 이쪽입니다 :P
          </p>
          <Link to="/">
            <button
              className={`
